...
def parse_google(htmlstring, driver, f):
    ...
    print("///---------Google Search--------------///")
    with open('nfl_flashscore.json') as json_file:
        ...
        for item in items:
            ...
            try:
                ...
                try:
                    gameStatus = driver.find_element_by_xpath("//div[contains(@class, 'imspo_mt__match-status')]").text
                except:
                    gameStatus = "Not"
...
with open("nfl_google.json", "w", encoding='utf8') as f:
    f.write('[\n')
